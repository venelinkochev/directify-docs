---
title: "Directify API Authentication with Sanctum Tokens"
icon: "key"
description: "Authenticate requests to the Directify REST API using Laravel Sanctum personal access tokens — generate, scope, rotate, and revoke from your account."
---
